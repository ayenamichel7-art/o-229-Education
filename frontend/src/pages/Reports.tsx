  ...
  return (
    <div className="erp-page">
      ...
      >
        ...
        <div>
          <p style={{ fontWeight: 600, color: "#6366f1", marginBottom: 4 }}>
            {t("reports_page.robots_active")}
          </p>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Extraction des Bulletins Académiques
            </h2>
            <p style={{ color: "#64748B", fontSize: "0.9rem" }}>
              Générez les relevés de notes officiels pour toute une classe ou
          ...
          <button
            ...
            onClick={() =>
              toast("Fonctionnalité d'extraction groupée bientôt disponible !")
            }
            style={{
              display: "flex",
              alignItems: "center",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {isLoading ? (
          <div style={{ padding: 48, textAlign: "center", color: "#94a3b8" }}>
            {t("reports_page.loading_reports")}
          </div>
        ) : (
          reports
            .filter(
                ...
                >
                  ...
                  >
                    ...
                    {report.status === "completed" && report.file_url ? (
                      ...
                      <button
                        onClick={() =>
                          toast.error("Ce fichier n'est plus disponible")
                        }
                        style={{
                          background: "#cbd5e1",
                          border: "none",
