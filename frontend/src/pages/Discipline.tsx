...
export const DisciplinePage: React.FC = () => {
  ...
  const getCategoryTheme = (cat: string) => {
    switch (cat) {
      case "merit":
        return { bg: "#ECFDF5", text: "#059669", icon: Trophy };
      case "sanction":
        return { bg: "#FEF2F2", text: "#DC2626", icon: ShieldAlert };
      default:
        return { bg: "#FFFBEB", text: "#D97706", icon: AlertTriangle };
    }
  };
      ...
      <header className="page-header" style={{ marginBottom: "2.5rem" }}>
        <div>
          ...
          <p style={{ color: "var(--text-muted)" }}>
            Gérez les mérites, les sanctions et l'engagement des parents.
          </p>
        </div>
        <button
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        <span>
                          Motif: <b style={{ color: "#1E293B" }}>{r.reason}</b>
                        </span>
                        <span>•</span>
              ...
              {formData.category === "sanction" && (
                <div className="form-group" style={{ marginBottom: "1.5rem" }}>
                  ...
                  >
                    ...
                    <option value="Exclusion temporaire">
                      Exclusion temporaire
                    </option>
                    <option value="Blâme">Blâme officiel</option>
                    <option value="Avertissement écrit">
                      Avertissement écrit
                    </option>
                  </select>
                </div>
