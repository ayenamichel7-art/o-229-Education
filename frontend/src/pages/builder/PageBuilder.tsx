      ...
      case "hero":
        return (
          ...
          >
            ...
            >
              {block.data.title || "Titre Principal"}
            </h2>
            <p style={{ opacity: 0.7 }}>
              {block.data.subtitle || "Sous-titre accrocheur"}
            </p>
          </div>
        );
      case "text":
        return (
          <div style={{ padding: "2rem" }}>
            <h3 style={{ fontSize: "1.25rem", marginBottom: "0.75rem" }}>
              {block.data.title || "Titre de Section"}
            </h3>
            <p style={{ color: "#64748b" }}>
              {block.data.body || "Contenu textuel dela section..."}
            </p>
          </div>
        );
      case "cta":
        ...
        return (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Téléchargez notre app pour suivre les notes et devoirs.
              </p>
              <button
                className="btn btn-primary"
                style={{
          ...
          setBlocks([
            {
              ...
              type: "hero",
              data: {
                title: "Lycée Excellence",
                subtitle: "L'éducation de demain, aujourd'hui.",
              },
            },
            {
              id: "b2",
              ...
              data: {
                title: "Notre Vision",
                body: "Nous croyons en un apprentissage personnalisé...",
              },
            },
          ]);
        }
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            <h2 style={{ fontSize: "1rem", fontWeight: 700 }}>
              Constructeur de Site Vitrine
            </h2>
            <p style={{ fontSize: "0.7rem", color: "#64748b" }}>
              Modification de : page-accueil
            </p>
          </div>
        </div>
          ...
          <div style={{ padding: "0.5rem 0" }}>
            ...
            >
              {BLOCK_TEMPLATES.map((t) => (
                ...
                >
                  <div style={{ color: t.color, marginBottom: "0.5rem" }}>
                    {t.icon}
                  </div>
          ...
          {selectedBlock ? (
            <div className="animate-fade-in">
              ...
              >
                ...
                >
                  {
                    BLOCK_TEMPLATES.find((t) => t.id === selectedBlock.type)
                      ?.icon
                  }
                </div>
                <div>
                    ...
                    setBlocks(
                      blocks.map((b) =>
                        b.id === selectedBlockId
                          ? { ...b, data: { ...b.data, title: e.target.value } }
                          : b,
                      ),
                    )
                  }
                      ...
                      setBlocks(
                        blocks.map((b) =>
                          b.id === selectedBlockId
                            ? {
                                ...b,
                                data: { ...b.data, subtitle: e.target.value },
                              }
                            : b,
                        ),
                      )
            ...
            >
              ...
              <p style={{ fontSize: "0.875rem" }}>
                Sélectionnez une section sur le canevas pour la personnaliser de
                A à Z.
              </p>
            </div>
          )}
