  ...
  const handleAddInteraction = async (e: React.FormEvent) => {
    ...
    try {
      await apiClient.post(
        `/crm-parents/${selectedStudentId}/interactions`,
        formData,
      );
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              ...
              <div>
                ...
                >
                  {g.guardian_name || "Non Renseigné"}
                </h3>
                <span
                  style={{ color: "var(--text-muted)", fontSize: "0.85rem" }}
                >
                  {g.guardian_relationship || "Responsable Légal"}
                </span>
              </div>
            </div>
            ...
            >
              ...
              {g.last_interaction_date && (
                ...
                >
                  <Clock size={14} /> Dernier contact :{" "}
                  {new Date(g.last_interaction_date).toLocaleDateString()}
                </div>
              )}
            </div>
          ...
          >
            ...
            <div style={{ padding: "1.5rem", background: "var(--surface-50)" }}>
              ...
              >
                ...
                <textarea
                  ...
                  className="form-input"
                  rows={3}
                  placeholder="Résumez la discussion pour vos collègues... (Crypté en base de données)"
            ...
            >
              ...
              {interactions.length === 0 && (
                ...
                >
                  Dossier vierge. Aucune interaction enregistrée.
                </p>
              )}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {interaction.staff?.first_name}{" "}
                          {interaction.staff?.last_name}
                        </span>
                        <span
                          style={{
                            fontSize: "0.75rem",
