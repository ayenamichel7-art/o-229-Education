...
export const Dashboard: React.FC = () => {
  ...
  const handleDownloadReport = async () => {
    ...
    alert(
      "Le rapport PDF/Excel généré par le robot a été téléchargé avec succès.",
    );
  };
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-muted)" }}>
            {t("dashboard.header_subtitle", {
              name: tenant?.name || t("common.school"),
            })}
          </p>
        </div>
        <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
          ...
          >
            <Download size={18} />{" "}
            {isDownloading ? t("common.generate") : t("common.download_report")}
          </button>
        </div>
      </header>
      ...
      >
        <StatCard
          ...
          title={t("dashboard.registered_students")}
        ...
        <StatCard
          ...
          diff={`${stats.collection_rate}% recouvrés`}
        />
        <StatCard
          icon={<UserPlus size={24} color="#EF4444" />}
          title={t("dashboard.pending_admissions")}
      ...
      >
        ...
        <div
          ...
          style={{ padding: "1.5rem", background: "white", height: "400px" }}
        >
          <h3
            style={{
              marginBottom: "1.5rem",
        ...
        >
          ...
          <ResponsiveContainer width="100%" height="85%">
            <BarChart
              data={[
                { name: "Maternelles", val: 120 },
                { name: "Primaires", val: 240 },
                { name: "Collégiens", val: 190 },
              ]}
            >
              <CartesianGrid
                strokeDasharray="3 3"
      ...
      {diff && (
        <span
          style={{
            fontSize: "0.85rem",
            fontWeight: 600,
            color: diff.startsWith("+") ? "#10B981" : "#EF4444",
            background: diff.startsWith("+") ? "#D1FAE5" : "#FEE2E2",
