...
export const SettingsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (tenant?.settings?.report_card) {
      setReportPrimaryColor(
        tenant.settings.report_card.primary_color || "#1E40AF",
      );
      setReportHeaderStyle(
        tenant.settings.report_card.header_style || "classic",
      );
    }
    if (tenant?.sealUrl) {
  ...
  const handleAutocomplete = async () => {
    ...
    try {
      const response = await apiClient.get(
        `/proxy/google-places?q=${encodeURIComponent(address)}`,
      );
  ...
  const handleFileUpload = async (type: "logo" | "seal", file: File) => {
    ...
    const toastId = toast.loading(
      `Importation du ${isLogo ? "logo" : "cachet"}...`,
    );
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
        ...
        <section
          ...
          style={{ padding: "2rem", border: "1px solid var(--surface-200)" }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <div>
              <h2 style={{ fontSize: "1.25rem", margin: 0 }}>
                {t("settings.gmb_title")}
              </h2>
              <p style={{ fontSize: "0.85rem", color: "var(--text-muted)" }}>
                {t("settings.gmb_subtitle")}
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "0.85rem", color: "var(--text-muted)" }}>
                Définissez l'apparence des documents officiels
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {logoUrl ? (
                      ...
                      <Globe size={32} color="var(--surface-300)" />
                    )}
                  </div>
                  <div style={{ flex: 1 }}>
                    <input
                ...
                >
                  ...
                  <p>
                    Recommandé : Format Carré (512x512px), PNG ou JPG, max 1Mo.
                    Évitez les marges blanches excessives.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  Cachet ou Signature Officielle
                </label>
                <div
                  style={{ display: "flex", alignItems: "center", gap: "1rem" }}
                >
                  ...
                  >
                    {sealUrl ? (
                      ...
                      <Palette size={32} color="var(--surface-300)" />
                    )}
                  </div>
                  <div style={{ flex: 1 }}>
                    <input
                      ...
                      onChange={(e) =>
                        e.target.files?.[0] &&
                        handleFileUpload("seal", e.target.files[0])
                      }
                    />
                    <button
                      onClick={() =>
                ...
                >
                  ...
                  />
                  <p>
                    <strong>Optimisation :</strong> Utilisez impérativement un
                    format **PNG transparent** pour que le cachet se superpose
                    naturellement aux documents.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <div
                  style={{ background: reportPrimaryColor, height: "15px" }}
                ></div>
                <div
                  style={{
                    padding: "8px",
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  <strong>Aperçu dynamique :</strong> Votre identité visuelle
                  sera appliquée aux bulletins et brochures.
                </p>
                <div style={{ display: "flex", gap: "1rem" }}>
                  ...
                  >
                    <Check size={12} />{" "}
                    {sealUrl ? "Cachet configuré" : "Cachet manquant"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <section
          className="glass-card"
          style={{ padding: "2rem", background: "var(--surface-50)" }}
        >
