    ...
    <div className="animate-fade-in">
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-muted)" }}>
            Contrôlez l'avancement pédagogique et les devoirs
          </p>
        </div>
      ...
      {!selectedClass ? (
        ...
        >
          ...
          />
          <p>
            Veuillez sélectionner une classe pour consulter le cahier de texte.
          </p>
        </div>
      ) : loading ? (
        <div style={{ textAlign: "center", padding: "5rem" }}>
          Chargement pédagogique...
        </div>
      ) : (
        <div
              ...
              >
                ...
                {log.homework && (
                  ...
                  >
                    ...
                    {log.homework_due_date && (
                      ...
                      >
                        ⏳ Échéance :{" "}
                        {new Date(log.homework_due_date).toLocaleDateString(
                          "fr-FR",
                        )}
                      </div>
                    )}
                ...
                >
                  ...
                  >
                    ...
                    >
                      {log.teacher?.user?.first_name[0]}
                      {log.teacher?.user?.last_name[0]}
                    </div>
                    <span style={{ fontWeight: 500 }}>
                      {log.teacher?.user?.first_name}{" "}
                      {log.teacher?.user?.last_name}
                    </span>
                  </div>
                </footer>
              </article>
