    ...
    <div className="erp-page">
      <div className="page-header" style={{ marginBottom: "2.5rem" }}>
        <div>
          ...
          <p style={{ color: "#64748B", marginTop: "0.5rem" }}>
            Diffusez des informations et engagez-vous avec la communauté
            scolaire.
          </p>
        </div>
        <button
      ...
      >
        ...
        {isLoading ? (
          ...
          <div
            style={{ padding: "5rem", textAlign: "center", color: "#64748B" }}
          >
            <MessageSquare
              size={48}
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 12,
                      background:
                        record.type === "emergency" ? "#FEE2E2" : "#EFF6FF",
                      color:
                        record.type === "emergency" ? "#EF4444" : "#3B82F6",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
                    ...
                    >
                      <span>
                        ...
                        <b style={{ color: "#1E293B" }}>
                          {record.metadata?.recipient_count || 0}
                        </b>
                      </span>
                      <span>•</span>
