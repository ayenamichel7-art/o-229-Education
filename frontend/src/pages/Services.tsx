...
export const AncillaryServices: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"transport" | "canteen">(
    "transport",
  );
      ...
      <header className="page-header" style={{ marginBottom: "2rem" }}>
        <div>
          ...
          <p style={{ color: "var(--text-muted)" }}>
            Gérez le transport scolaire et la restauration pour vos élèves.
          </p>
        </div>
        <div style={{ display: "flex", gap: "1rem" }}>
          ...
          >
            <Plus size={18} />{" "}
            {activeTab === "transport" ? "Nouveau Circuit" : "Nouveau Menu"}
          </button>
        </div>
      </header>
        ...
        >
          {transportRoutes.length === 0 ? (
            ...
            >
              <Bus
                size={48}
                style={{ margin: "0 auto 1.5rem", color: "#CBD5E1" }}
              />
            ...
            transportRoutes.map((route) => (
              <div
                key={route.id}
                className="glass-card h-full flex flex-col hover-scale"
                style={{
                  background: "white",
              ...
              >
                ...
                >
                  Véhicule: {route.vehicle_reg || "N/A"}
                </p>
                ...
                >
                  ...
                  >
                    ...
                    <span>
                      <b>{route.subscriptions_count}</b> /{route.capacity}{" "}
                      élèves inscrits
                    </span>
                  </div>
                  <div
              ...
              >
                ...
                >
                  ...
                  >
                    <Users size={16} />
                    <span>
                      Inscrits: <b>{plan.subscriptions_count}</b> élèves
                    </span>
                  </div>
                </div>
      ...
      >
        ...
        <div>
          ...
          <p style={{ margin: "4px 0 0", opacity: 0.9, fontSize: "0.9rem" }}>
            Les frais des services annexes sont automatiquement ajoutés aux
            factures mensuelles des parents inscrits.
          </p>
        </div>
      </div>
    </div>
