...
export const StudentModal: React.FC<StudentModalProps> = ({ isOpen, onClose, student }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const toastId = toast.loading(student ? t('common.updating') : 'Création en cours...');
    ...
    try {
      ...
      toast.error(err.response?.data?.message || 'Une erreur est survenue lors de la sauvegarde.', { id: toastId });
    } finally {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '1.5rem', overflowY: 'auto' }}>
          <form id="student-form" onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
               <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#475569', marginBottom: '0.25rem' }}>
                ...
                <select name="grade_id" value={formData.grade_id} onChange={handleChange}
                  style={{ width: '100%', padding: '0.75rem', borderRadius: '8px', border: '1px solid #CBD5E1', fontSize: '0.95rem', background: 'white' }}>
        ...
        <div style={{
          ...
          <button type="submit" form="student-form" disabled={isSubmitting} style={{
